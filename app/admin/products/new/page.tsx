  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        ...
        description: error instanceof Error ? error.message : "Ha ocurrido un error al guardar el producto",
        variant: "destructive",
      })
    } finally {
      setIsSaving(false)
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="bg-white rounded-lg shadow-sm p-6">
          <h1 className="text-2xl font-bold mb-6 text-black">Nuevo Producto</h1>
