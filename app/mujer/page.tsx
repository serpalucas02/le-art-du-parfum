...
export default async function WomensFragrancesPage() {
  // Cargar productos de la categoría "mujer"
  const products = await getProductsByCategory("mujer")

  // Lista de marcas para el filtro
  const brands = [
    { name: "Burberry", count: 5 },
    { name: "Calvin Klein", count: 8 },
    { name: "Carolina Herrera", count: 12 },
    { name: "Chanel", count: 10 },
    { name: "Dior", count: 15 },
    { name: "Dolce & Gabbana", count: 7 },
    { name: "Gucci", count: 9 },
    { name: "Lancome", count: 6 },
  ]
    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <Breadcrumb className="mb-8">
        <BreadcrumbList>
          ...
          <BreadcrumbItem>
            <BreadcrumbLink>Perfumes de mujer</BreadcrumbLink>
          </BreadcrumbItem>
        </BreadcrumbList>
      </Breadcrumb>
      ...
      <div className="flex flex-col lg:flex-row gap-8">
        ...
        <div className="flex-1">
          <div className="flex justify-between items-center mb-6">
            <h1 className="text-2xl font-bold">Perfumes de Mujer</h1>
