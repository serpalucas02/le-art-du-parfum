...
export default async function DecantsPage() {
  // Cargar productos de la categoría "decants"
  const products = await getProductsByCategory("decants")

  // Lista de marcas para el filtro
  const brands = [
    { name: "Amouage", count: 8 },
    { name: "Creed", count: 12 },
    { name: "Dior", count: 6 },
    { name: "Initio", count: 5 },
    { name: "Maison Francis Kurkdjian", count: 7 },
    { name: "Parfums de Marly", count: 10 },
    { name: "Tom Ford", count: 15 },
    { name: "Xerjoff", count: 9 },
  ]
    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <Breadcrumb className="mb-8">
        <BreadcrumbList>
          ...
          <BreadcrumbItem>
            <BreadcrumbLink>Decants</BreadcrumbLink>
          </BreadcrumbItem>
        </BreadcrumbList>
      </Breadcrumb>
      ...
      <div className="flex flex-col lg:flex-row gap-8">
        ...
        <div className="flex-1">
          <div className="flex justify-between items-center mb-6">
            <h1 className="text-2xl font-bold">Decants</h1>
